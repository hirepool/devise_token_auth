module DeviseTokenAuth
  class RegistrationsController < DeviseTokenAuth::ApplicationController
    ...
    def create
      ...
      if confirmable_enabled? && !confirm_success_url
        return render_create_error_missing_confirm_success_url
      end

      # if whitelist is set, validate confirm_success_url against whitelist
      if DeviseTokenAuth.redirect_whitelist
        unless DeviseTokenAuth::Url.whitelisted?(confirm_success_url)
    ...
    def confirm_success_url
      @confirm_success_url ||= sign_up_params[:confirm_success_url] || DeviseTokenAuth.default_confirm_success_url
    end
    ...
    def render_create_error_redirect_url_not_allowed
      ...
      message = I18n.t('devise_token_auth.registrations.redirect_url_not_allowed', redirect_url: confirm_success_url)
      render_error(422, message, response)
    end
